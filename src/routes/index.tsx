...
function Home() {
  ...
  return <div className="site-shell">
    <header className="nav wrap"><a className="brand" href="/" aria-label="Tafat home"><span className="brand-mark">t</span><span>tafat</span></a><nav><a href="#discover">Discover</a><a href="#about">Our approach</a><a href="#stay-in-loop">Stay in the loop</a></nav><a className="nav-pill" href="#stay-in-loop">Sign in / join</a></header>
    <main>
